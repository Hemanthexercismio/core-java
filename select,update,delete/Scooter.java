class Scooter {
	...
	{
		System.out.println("executing createin Scooter:");
	...
	{
		System.out.println("executing search in Scooter");
		...
		if(type != null)
		{
			...
			if(this.types != null)
			{
				for(String turbo : this.types)
				{
					...
					{
						System.out.println("scooter name:" + type);
						return true;
					}
				}
			}
	...
	{
		System.out.println("executing update in Scooter index and string");
	...
	{
		System.out.println("executing update in Scooter by old name to new name ");
		if(oldName!=null)
		{
	...
	{
		System.out.println("executing delete operation in Scooter using index");
	...
	{
		System.out.println("executing delete operation in Scooter using string value");
