class Steel {
	...
	{
		System.out.println("executing update in Steel index and string");
	...
	{
		System.out.println("executing update in Steel by old name to new name ");
		if(oldName!=null)
		{
	...
	{
		System.out.println("executing delete operation in Steel using index");
	...
	{
		System.out.println("executing delete operation in Steel using string value");
