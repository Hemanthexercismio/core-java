class Turbine {
	...
	{
		System.out.println("executing update in Turbine index and string");
		...
		{
			System.out.println("executing update in Turbine by old name to new name ");
			if(oldName!=null)
			{
				System.out.println("old name is not null u can update");
					if(newName!=null)
					{
						...
						for(int i=0;i<=this.types.length-1;i++){
							...
							if(this.types[i].equals(oldName)){
	...
	{
		System.out.println("executing delete operation in Turbine using index");
	...
	{
		System.out.println("executing delete operation in Turbine using string value");
