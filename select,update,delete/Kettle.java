class Kettle {
	...
	{
		System.out.println("executing update in Kettle index and string");
	...
	{
		System.out.println("executing update in Kettle by old name to new name ");
		if(oldName!=null)
		{
	...
	{
		System.out.println("executing delete operation in Kettle using index");
	...
	{
		System.out.println("executing delete operation in Kettle using string value");
